/*  TidelibCrescentBeachMatanzasRiverICWWFlorida.cpp 
...
// Selected station: Crescent Beach, Matanzas River, ICWW, Florida
char stationID[] = "Crescent Beach, Matanzas River, ICWW, Florida";
// Selection station ID number: 8720651
const long stationIDnumber = 8720651;
...
const prog_float_t Kappa[] PROGMEM = {258,225.1,87.1,39,288.3,54.9,244,1.3,203.9,88.7,44.5,20.5,227.9,262.3,221.8,221.7,247.4,331.4,196.3,88,16.3,1.3,82.4,44.5,109.4,31.6,226.5,107.5,95.2,338.2,51.3,146.7,302.3,148.2,74.8,209,14.8};
